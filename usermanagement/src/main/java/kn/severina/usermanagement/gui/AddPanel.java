...
import kn.severina.usermanagement.util.Messages;
...
public class AddPanel extends JPanel implements ActionListener {
	...
	private JPanel getFieldPanel() {
		if (fieldPanel == null) {
			...
			addLabeledField(
					fieldPanel,
					Messages.getString("AddPanel.first_name"), getFirstNameField()); //$NON-NLS-1$
			addLabeledField(
					fieldPanel,
					Messages.getString("AddPanel.last_name"), getLastNameField()); //$NON-NLS-1$
			addLabeledField(
					fieldPanel,
					Messages.getString("AddPanel.date_of_birth"), getDateOfBirthField()); //$NON-NLS-1$
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("ok".equalsIgnoreCase(e.getActionCommand())) {
			...
			try {
				user.setDateOfBirthd(format.parse(getDateOfBirthField()
						.getText()));
